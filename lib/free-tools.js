// Free Tools registry. Each entry powers /free-tools/[slug] and the
// /free-tools index. Add new entries here, not by writing new pages.
//
// When the actual asset (PDF) is ready, drop it in /public/free-tools/<slug>.pdf
...
export const FREE_TOOLS = [
  {
    ...
    pages: 22,
    assetUrl: null, // Drop PDF at /public/free-tools/borrowers-guide.pdf when ready
...
export function getFreeToolBySlug(slug) {
