...
// "Hand Over to John" — the form embedded in Charles A.I's hand-off button.
// Triggered (in GHL) by form submission → John's follow-up workflow.
export const HANDOVER_FORM = {
  id: "4QpLNP0k5KOkCI9QSw2G",
  name: "Hand Over to John",
  height: 647,
};
...
export function handoverFormSrc({ theme = "dark", conversation = "" } = {}) {
  ...
  return `${GHL_FORM_HOST}/widget/form/${HANDOVER_FORM.id}?${p.toString()}`;
}
