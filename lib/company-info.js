...
export const COMPANY = {
  ...
  phoneMobile: "0414 870 655",
  phoneMobileHref: "tel:+61414870655",
  fax: "02 9475 0169",
  ...
  // Governing law (kept separate — current draft uses Victoria,
  // which you confirmed earlier. Update only if the legal entity
  // is re-registered or counsel advises otherwise.)
  governingLaw: {
    state: "Victoria",
    courts: "the courts of Victoria and the Federal Court of Australia",
  },
